...
public class StartCommandHandler implements CommandHandler {
    ...
    public BotApiMethod<?> processCommand(Message message) {
        String helloMessage = """
                Привет, %s! Меня зовут Тимпи. Я воплощение бога медицины, а также твой медицинский помощник, готовый ответить на все твои вопросы о здоровье. Здесь ты можешь получить информацию о симптомах, заболеваниях, лекарствах и многом другом.
